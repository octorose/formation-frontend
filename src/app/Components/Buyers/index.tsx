...
const cardData: cardDataType[] = [
  {
    ...
    percent: "80k+",
    heading: "Candidates Managed",
    subheading:
      "Effortlessly manage and track candidates throughout the recruitment process.",
  },
  {
    ...
    heading: "Jobs Posted",
    subheading:
      "Manage Position needs listings to attract top talent for your organization.",
  },
  {
    imgSrc: "/assets/buyers/happybuyers.svg",
    percent: "80%",
    heading: "Training Completion Rate",
    subheading:
      "Boost employee skills and productivity with our comprehensive training programs.",
  },
  {
    imgSrc: "/assets/buyers/teammembers.svg",
    percent: "50+",
    heading: "HR Team Members Empowered",
    subheading:
      "Empower your HR team with powerful tools and insights to streamline processes.",
  },
];
