...
const Aboutdata: datatype[] = [
  {
    ...
    paragraph:
    "Manage candidate applications, test results, and training progress in one place.",
},
{
    imgSrc: "/assets/provide/graphic.svg",
    country: "Streamlined Training Process",
    paragraph:
    "Automate training schedules, assignments, and evaluations for a more efficient training process",
},
{
    imgSrc: "/assets/provide/marketing.svg",
    country: "Enhanced Collaboration",
    paragraph:
      " Facilitate communication and coordination between HR, training camp, trainers, supervisors, and candidates",
  },
  {
    imgSrc: "/assets/provide/uidesign.svg",
    country: "Data-Driven Insights",
    paragraph: "Track candidate performance, training effectiveness, and training needs to inform future improvements",
  },
];
            ...
            <div className="col-span-6 flex justify-center">
              <div className="flex flex-col gap-17 align-middle justify-center p-10">
                ...
                <h4 className="text-lg pt-4 font-normal lh-33 text-center lg:text-start text-bluegray">
                  Efficiently manage the entire recruitment and training process
                  for new hires - from candidate screening and skills
                  assessments to onboarding and comprehensive workforce
                  readiness training. Our integrated platform empowers HR teams,
                  training camp coordinators, instructors, line supervisors, and
                  candidates themselves to collaborate seamlessly throughout
                  each phase of the talent acquisition journey. Gain invaluable
                  insights, monitor progress, and ensure a smooth transition for
