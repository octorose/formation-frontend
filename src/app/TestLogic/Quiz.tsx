...
const Quiz = () => {
    ...
    const handleRaisonChange = (e:any) => {
        ...
        if (!isNaN(number) && number >= 1.40 && number <= 2.10) {
            ...
            setHeight(value);
            setErrorMessage('Veuillez entrer votre reponse valide (entre 1.40 m et 2.10 m)');
        }
    };
    ...
    return (
            ...
            {result ? (
                ...
                <>
                    ...
                    <div className="timer-box">
                        <div className="timer-container">
                            ...
                            <div className="timer-bar">
                                <div className="timer-bar-inner" style={{ width: `${(timeLeft / 60) * 100}%` }}></div>
                            </div>
                        </div>
                    ...
                    {index === 1 && ( // Afficher le rectangle bleu pour la question 2 (index 1)
                        <div className="color-box" style={{ backgroundColor: 'blue', width: '100px', height: '100px', margin: '20px auto' }}></div>
                    )}
                    {index === 2 && ( // Afficher le rectangle noir pour la question 3 (index 2)
                        <div className="color-box" style={{ backgroundColor: 'black', width: '100px', height: '100px', margin: '20px auto' }}></div>
                    )}
                    {index === 3 && ( // Afficher le rectangle rouge pour la question 4 (index 3)
                        <div className="color-box" style={{ backgroundColor: 'red', width: '100px', height: '100px', margin: '20px auto' }}></div>
                    )}
                    {index === 4 && ( // Afficher le rectangle rouge pour la question 5 (index 4)
                        <div className="color-box" style={{ backgroundColor: 'blue', width: '100px', height: '100px', margin: '20px auto', opacity: '20' }}></div>
                    )}
                    {index === 5 && ( // Afficher le rectangle rouge pour la question 6 (index 5)
                        <div className="color-box" style={{ backgroundColor: 'yellow', width: '100px', height: '100px', margin: '20px auto' }}></div>
                    )}
                    ...
                    {index === 7 && ( // Afficher le rectangle bleu pour la question 8 (index 7)
                        <div className="color-box" style={{ backgroundColor: 'pink', width: '100px', height: '100px', margin: '20px auto' }}></div>
                    )}
                    {index === 8 && ( // Afficher le rectangle bleu pour la question 9 (index 8)
                        <div className="color-box" style={{ backgroundColor: 'orange', width: '100px', height: '100px', margin: '20px auto' }}></div>
                    )}
                    ...
                    {index === 11 && ( // Afficher le rectangle bleu pour la question 12 (index 11)
                        <div className="color-box" style={{ backgroundColor: 'green', width: '100px', height: '100px', margin: '20px auto' }}></div>
                    )}
        ...
        <div style={{ backgroundColor: 'blue', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
        <div style={{ backgroundColor: 'black', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
        <div style={{ backgroundColor: 'red', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
        <div style={{ backgroundColor: 'blue', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
        <div style={{ backgroundColor: 'yellow', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
        <div style={{ backgroundColor: 'blue', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
        <div style={{ backgroundColor: 'pink', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
        <div style={{ backgroundColor: 'orange', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
        <div style={{ backgroundColor: 'yellow', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
        <br />
        <div style={{ backgroundColor: 'blue', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
        <div style={{ backgroundColor: 'green', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
        <div style={{ backgroundColor: 'black', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
        <div style={{ backgroundColor: 'pink', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
        <div style={{ backgroundColor: 'red', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
        <div style={{ backgroundColor: 'black', display: 'inline-block', width: '60px', height: '60px', margin: '5px' }}></div>
...
{index === 22 && (
                        <div className="image-container">
                            <img src="/image/Qst22.PNG" alt="Question Image" />
                        </div>
                    )}
{index === 23 && (
                        <div className="image-container">
